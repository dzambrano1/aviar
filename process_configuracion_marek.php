...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO ac_marek (ac_marek_vacuna, ac_marek_dosis, ac_marek_costo, ac_marek_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE ac_marek 
                    SET ac_marek_vacuna = :vacuna, 
                        ac_marek_dosis = :dosis, 
                        ac_marek_costo = :costo, 
                        ac_marek_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM ac_marek WHERE id = :id";
