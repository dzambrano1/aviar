...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    if ($_POST['action'] === 'insert' && isset($_POST['tagid'], $_POST['dosis'], $_POST['producto'], $_POST['costo'], $_POST['fecha'])) {
        try {
    ...
    } elseif ($_POST['action'] === 'update' && isset($_POST['id'], $_POST['dosis'], $_POST['producto'], $_POST['costo'], $_POST['fecha'])) {
        try {
