...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO ac_encefalomielitis (ac_encefalomielitis_vacuna, ac_encefalomielitis_dosis, ac_encefalomielitis_costo, ac_encefalomielitis_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE ac_encefalomielitis 
                    SET ac_encefalomielitis_vacuna = :vacuna, 
                        ac_encefalomielitis_dosis = :dosis, 
                        ac_encefalomielitis_costo = :costo, 
                        ac_encefalomielitis_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM ac_encefalomielitis WHERE id = :id";
