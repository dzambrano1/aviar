...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO ac_coriza (ac_coriza_vacuna, ac_coriza_dosis, ac_coriza_costo, ac_coriza_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE ac_coriza 
                    SET ac_coriza_vacuna = :vacuna, 
                        ac_coriza_dosis = :dosis, 
                        ac_coriza_costo = :costo, 
                        ac_coriza_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM ac_coriza WHERE id = :id";
