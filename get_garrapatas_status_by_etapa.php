...
try {
    ...
    $sql_counts = "
        SELECT
            ...
            COUNT(DISTINCT co.ah_garrapatas_tagid) AS vaccinated_animals
        FROM aviar a
        LEFT JOIN ah_garrapatas co ON a.tagid = co.ah_garrapatas_tagid
    ...
    $sql_list = "
        ...
        LEFT JOIN ah_garrapatas co ON a.tagid = co.ah_garrapatas_tagid
        WHERE a.etapa IN ('Inicio', 'Crecimiento', 'Finalizacion') 
          AND co.ah_garrapatas_tagid IS NULL
