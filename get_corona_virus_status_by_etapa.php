...
try {
    ...
    $sql_counts = "
        SELECT
            ...
            COUNT(DISTINCT cr.ah_corona_virus_tagid) AS vaccinated_animals
        FROM aviar a
        LEFT JOIN ah_corona_virus cr ON a.tagid = cr.ah_corona_virus_tagid
    ...
    $sql_list = "
        ...
        LEFT JOIN ah_corona_virus cr ON a.tagid = cr.ah_corona_virus_tagid
        WHERE a.etapa IN ('Inicio', 'Crecimiento', 'Finalizacion') 
          AND cr.ah_corona_virus_tagid IS NULL
    ...
    error_log("Error fetching CRD (Neumonia) status by etapa: " . $e->getMessage());
