...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO ac_neumonia (ac_neumonia_vacuna, ac_neumonia_dosis, ac_neumonia_costo, ac_neumonia_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE ac_neumonia 
                    SET ac_neumonia_vacuna = :vacuna, 
                        ac_neumonia_dosis = :dosis, 
                        ac_neumonia_costo = :costo, 
                        ac_neumonia_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM ac_neumonia WHERE id = :id";
