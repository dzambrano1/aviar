...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO ac_influenza (ac_influenza_vacuna, ac_influenza_dosis, ac_influenza_costo, ac_influenza_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE ac_influenza 
                    SET ac_influenza_vacuna = :vacuna, 
                        ac_influenza_dosis = :dosis, 
                        ac_influenza_costo = :costo, 
                        ac_influenza_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM ac_influenza WHERE id = :id";
