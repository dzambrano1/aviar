...
try {
    ...
    $sql_counts = "
        SELECT
            ...
            COUNT(DISTINCT co.ah_influenza_tagid) AS vaccinated_animals
        FROM aviar a
        LEFT JOIN ah_influenza co ON a.tagid = co.ah_influenza_tagid
    ...
    $sql_list = "
        ...
        LEFT JOIN ah_influenza co ON a.tagid = co.ah_influenza_tagid
        WHERE a.etapa IN ('Inicio', 'Crecimiento', 'Finalizacion') 
          AND co.ah_influenza_tagid IS NULL
    ...
    error_log("Error fetching influenza status by etapa: " . $e->getMessage());
