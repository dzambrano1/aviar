...
try {
    ...
    $sql_counts = "
        SELECT
            ...
            COUNT(DISTINCT co.ah_coriza_tagid) AS vaccinated_animals
        FROM aviar a
        LEFT JOIN ah_coriza co ON a.tagid = co.ah_coriza_tagid
    ...
    $sql_list = "
        ...
        LEFT JOIN ah_coriza co ON a.tagid = co.ah_coriza_tagid
        WHERE a.etapa IN ('Inicio', 'Crecimiento', 'Finalizacion') 
          AND co.ah_coriza_tagid IS NULL
    ...
    error_log("Error fetching Coriza status by etapa: " . $e->getMessage());
