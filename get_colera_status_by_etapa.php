...
try {
    ...
    $sql_counts = "
        SELECT
            ...
            COUNT(DISTINCT co.ah_colera_tagid) AS vaccinated_animals
        FROM aviar a
        LEFT JOIN ah_colera co ON a.tagid = co.ah_colera_tagid
    ...
    $sql_list = "
        ...
        LEFT JOIN ah_colera co ON a.tagid = co.ah_colera_tagid
        WHERE a.etapa IN ('Inicio', 'Crecimiento', 'Finalizacion') 
          AND co.ah_colera_tagid IS NULL
    ...
    error_log("Error fetching Colera status by etapa: " . $e->getMessage());
