...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO ac_parasitos (ac_parasitos_vacuna, ac_parasitos_dosis, ac_parasitos_costo, ac_parasitos_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE ac_parasitos 
                    SET ac_parasitos_vacuna = :vacuna, 
                        ac_parasitos_dosis = :dosis, 
                        ac_parasitos_costo = :costo, 
                        ac_parasitos_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM ac_parasitos WHERE id = :id";
