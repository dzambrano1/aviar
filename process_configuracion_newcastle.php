...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO ac_newcastle (ac_newcastle_vacuna, ac_newcastle_dosis, ac_newcastle_costo, ac_newcastle_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE ac_newcastle 
                    SET ac_newcastle_vacuna = :vacuna, 
                        ac_newcastle_dosis = :dosis, 
                        ac_newcastle_costo = :costo, 
                        ac_newcastle_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM ac_newcastle WHERE id = :id";
