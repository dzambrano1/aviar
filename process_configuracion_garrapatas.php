...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO ac_garrapatas (ac_garrapatas_vacuna, ac_garrapatas_dosis, ac_garrapatas_costo, ac_garrapatas_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE ac_garrapatas 
                    SET ac_garrapatas_vacuna = :vacuna, 
                        ac_garrapatas_dosis = :dosis, 
                        ac_garrapatas_costo = :costo, 
                        ac_garrapatas_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM ac_garrapatas WHERE id = :id";
